        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoUrlPath = table.Column<string>(type: "text", nullable: true),
                    AveragePrice = table.Column<float>(type: "real", nullable: false),
                    Rating = table.Column<decimal>(type: "numeric(7,3)", precision: 7, scale: 3, nullable: false),
